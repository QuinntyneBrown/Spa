...
namespace Spa.Core.Builders
{
    ...
    public class BarrelGenerator: IBarrelGenerationStrategy
    {
        ...
        public BarrelGenerator(ICommandService commandService, IFileSystem fileSystem, string appDirectory)
        {
        ...
        public BarrelGenerator LoadTsConfig(string path)
        {
            _source = path;
        ...
        public BarrelGenerator Add(string path)
        {
