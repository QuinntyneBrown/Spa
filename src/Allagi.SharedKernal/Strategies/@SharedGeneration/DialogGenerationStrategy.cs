...
{
    public interface IDialogGenerationStrategy
    {

    }

    public class DialogGenerationStrategy: IDialogGenerationStrategy
    {
        private static readonly string TEMPLATE_NAME = "Dialog";
